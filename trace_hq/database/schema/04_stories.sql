...
CREATE TABLE IF NOT EXISTS `stories` (
  ...
  `project_id`            INT UNSIGNED NOT NULL COMMENT 'Project this story belongs to; determines backlog when workflow_id NULL',
  ...
  KEY `ix_stories_backlog_order` (`project_id`, `backlog_order`),
