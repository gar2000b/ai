...
INSERT INTO `stories` (
  `id`, `title`, `description`, `type`, `priority`, `workflow_id`, `workflow_stage_id`,
...
('S001', 'Add /health endpoint', 'Implement a basic health endpoint returning service status.', 'dev', 'medium',
...
('S002', 'Write Getting Started guide', 'Create onboarding documentation for new developers.', 'writing', 'high',
...
('S003', 'Add config loader', 'Support loading configuration from env and JSON file.', 'dev', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S004', 'Add integration test for config loader', 'Validate config loader across env + file interaction.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S005', 'Add readiness endpoint', 'Add readiness endpoint dependent on health endpoint.', 'dev', 'low',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S006', 'Load test /health endpoint', 'Validate health endpoint under 10k RPS load.', 'performance', 'medium',
...
('S007', 'Setup staging deployment pipeline', 'Add GitHub Actions workflow for staging environment.', 'infrastructure', 'high',
...
('S008', 'Research JWT expiry strategy', 'Evaluate token expiry and refresh approaches.', 'research', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'manual'),
...
('S009', 'Add logging middleware', 'Log method + path for all requests.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S010', 'Create epic roadmap draft', 'Draft roadmap for next 3 months.', 'manual', 'critical',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'manual'),
...
('S011', 'Unit test health endpoint', 'Add isolated unit tests for /health route and response shape.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S012', 'Unit tests for config loader', 'Isolated tests for config loader module.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S013', 'Review unit tests for config loader', 'Owner review of S012 unit test PR before merge.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S014', 'Integration test plan for health + ready', 'Plan integration tests for health and readiness endpoints together.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S015', 'Integration tests for health + ready', 'Implement integration tests for health and readiness in harness.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S016', 'Review integration tests (health + ready)', 'Owner review of integration test PR for health and ready.', 'dev', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'development'),
...
('S017', 'Load test config loader', 'Validate config loader performance under load.', 'performance', 'low',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'performance'),
...
('S018', 'Plan load test for /ready', 'Define load and latency targets for readiness endpoint.', 'performance', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'performance'),
...
('S019', 'Review health endpoint load test', 'Owner approval of S006 load test results and thresholds.', 'performance', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'performance'),
...
('S020', 'Load test readiness endpoint', 'Load test /ready; completed and approved.', 'performance', 'low',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'performance'),
...
('S021', 'Production deployment pipeline', 'Add GitHub Actions workflow for production with approvals.', 'infrastructure', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'devops'),
...
('S022', 'Plan production deployment', 'Design production deploy steps and approval flow.', 'infrastructure', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'devops'),
...
('S023', 'Implement production deploy workflow', 'Add production workflow YAML and approval job.', 'infrastructure', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'devops'),
...
('S024', 'Staging pipeline completed', 'Staging deployment pipeline implemented and approved (historical).', 'infrastructure', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'devops'),
...
('S025', 'Plan Q2 roadmap', 'Outline Q2 themes and milestones for stakeholder review.', 'manual', 'high',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'manual'),
...
('S026', 'Document API decisions', 'Record API versioning and error-format decisions; completed.', 'docs', 'medium',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'manual'),
...
('S027', 'Triage support backlog', 'Review and prioritise open support items for next sprint.', 'manual', 'low',
 (SELECT id FROM workflows WHERE project_id = 1 AND code = 'manual'),
 (SELECT ws.id FROM workflow_stages ws JOIN workflows w ON ws.workflow_id = w.id WHERE w.project_id = 1 AND w.code = 'manual' AND ws.stage_name = 'Todo'),
