...
Process command logs: read `.txt` files in the command directory, generate `.md` reports with sanitized command lists and details, then rename source files to `.done`.
